...
//		log.info(mv.getModel().get("list"));
	...
	public void testRegister() throws Exception {
		...
		MvcResult result = mockMvc.perform(MockMvcRequestBuilders.post("/freeboard/register")
						.param("title", "고고새글 제목TEST")
						.param("content", "테스트 새글 내용")
						.param("Member_no",""+1 )) //1을 string으로 형변환
			.andReturn();
	...
	public void testGet() throws Exception {
		MvcResult result = mockMvc.perform(MockMvcRequestBuilders.get("/freeboard/get")
				.param("no", "1"))
			.andReturn();
	...
	public void testModify() throws Exception {
		...
		MvcResult result = mockMvc.perform(MockMvcRequestBuilders.post("/freeboard/modify")
				.param("no", key + "")
				.param("title", "kk수정된 게시물111")
				.param("content", "kk수정된 본문1111")
				.param("Member_no", ""+1))
			.andReturn();
	...
	public void testRemove() throws Exception {
		...
		MvcResult result = mockMvc.perform(MockMvcRequestBuilders.post("/freeboard/remove")
				.param("no", key + ""))
			.andReturn();
